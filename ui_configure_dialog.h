...
public:
    ...
    void setupUi(QDialog *ConfigureDialog)
    {
        ...
        cpu_line_color->setEnabled(false);
        ...
        outer_border_color->setEnabled(false);
        ...
        swap_chart_color->setEnabled(false);
        ...
        mem_chart_color->setEnabled(false);
        ...
        cpu_usage_color->setEnabled(false);
