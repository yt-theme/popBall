#############################################################################
# Makefile for building: popBall
# Generated by qmake (3.1) (Qt 5.14.1)
# Project:  popBall.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile popBall.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = popBall1.0.0
DISTDIR = /home/yt/pro/qt/popBall/.tmp/popBall1.0.0
LINK          = g++
LFLAGS        = -static -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now
LIBS          = $(SUBLIBS) /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Network.so /usr/lib/libQt5Core.so -lGL -lpthread -lmd4c   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = data_struct/data_struct.cpp \
		...
		widget/widget_WindowPositionStyle.cpp qrc_clock.cpp \
		qrc_mail.cpp \
		moc_configure_dialog.cpp \
		moc_widget.cpp \
		moc_mail_dialog.cpp \
		moc_threads.cpp
OBJECTS       = data_struct.o \
		global_data.o \
		configure_dialog.o \
		mail_dialog.o \
		get_sys_info.o \
		...
		widget_EventFunc.o \
		widget_Initial.o \
		widget_RightContextMenu.o \
		widget_UIAndPaintEvent.o \
		widget_WindowPositionStyle.o \
		qrc_clock.o \
		qrc_mail.o \
		moc_configure_dialog.o \
		moc_widget.o \
		moc_mail_dialog.o \
		moc_threads.o
DIST          = res/mail.svg \
		...
		popBall.pro header/configure_dialog.h \
		...
		utils/pop3.h \
		utils/threads.h data_struct/data_struct.cpp \
		data_struct/global_data.cpp \
		dialog/configure_dialog.cpp \
		dialog/mail_dialog.cpp \
		get_sys_info/get_sys_info.cpp \
...
popBall: ui_configure_dialog.h ui_mail_dialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: popBall.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents res/clock.qrc res/mail.qrc $(DISTDIR)/
	$(COPY_FILE) --parents /usr/lib/qt/mkspecs/features/data/dummy.cpp $(DISTDIR)/
	$(COPY_FILE) --parents header/configure_dialog.h header/data_struct.h header/define.h header/get_sys_info.h header/widget.h \ interface/plugins_interface.h header/mail_dialog.h utils/dealtConfigFile.h utils/pop3.h utils/threads.h $(DISTDIR)/
	$(COPY_FILE) --parents data_struct/data_struct.cpp data_struct/global_data.cpp dialog/configure_dialog.cpp dialog/mail_dialog.cpp get_sys_info/get_sys_info.cpp main.cpp utils/dealtConfigFile.cpp utils/pop3.cpp utils/threads.cpp widget/widget.cpp widget/widget_ConfigFile.cpp widget/widget_Content.cpp widget/widget_Ending.cpp widget/widget_EventFunc.cpp widget/widget_Initial.cpp widget/widget_RightContextMenu.cpp widget/widget_UIAndPaintEvent.cpp widget/widget_WindowPositionStyle.cpp $(DISTDIR)/
	$(COPY_FILE) --parents configure_dialog.ui mail_dialog.ui $(DISTDIR)/
...
compiler_rcc_make_all: qrc_clock.cpp qrc_mail.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_clock.cpp qrc_mail.cpp
qrc_clock.cpp: res/clock.qrc \
		/usr/bin/rcc \
		res/clock.svg
	/usr/bin/rcc -name clock res/clock.qrc -o qrc_clock.cpp

qrc_mail.cpp: res/mail.qrc \
		/usr/bin/rcc \
		res/mail.svg
	/usr/bin/rcc -name mail res/mail.qrc -o qrc_mail.cpp
...
compiler_moc_header_make_all: moc_configure_dialog.cpp moc_widget.cpp moc_mail_dialog.cpp moc_threads.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_configure_dialog.cpp moc_widget.cpp moc_mail_dialog.cpp moc_threads.cpp
moc_configure_dialog.cpp: header/configure_dialog.h \
		header/define.h \
		header/data_struct.h \
		header/widget.h \
		header/get_sys_info.h \
		...
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/yt/pro/qt/popBall/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/yt/pro/qt/popBall -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtCore -I/usr/include/c++/9.2.0 -I/usr/include/c++/9.2.0/x86_64-pc-linux-gnu -I/usr/include/c++/9.2.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.2.0/include-fixed -I/usr/include header/configure_dialog.h -o moc_configure_dialog.cpp

moc_widget.cpp: header/widget.h \
		header/define.h \
		header/get_sys_info.h \
		header/data_struct.h \
		header/configure_dialog.h \
		...
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/yt/pro/qt/popBall/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/yt/pro/qt/popBall -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtCore -I/usr/include/c++/9.2.0 -I/usr/include/c++/9.2.0/x86_64-pc-linux-gnu -I/usr/include/c++/9.2.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.2.0/include-fixed -I/usr/include header/widget.h -o moc_widget.cpp

moc_mail_dialog.cpp: header/mail_dialog.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/yt/pro/qt/popBall/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/yt/pro/qt/popBall -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtCore -I/usr/include/c++/9.2.0 -I/usr/include/c++/9.2.0/x86_64-pc-linux-gnu -I/usr/include/c++/9.2.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.2.0/include-fixed -I/usr/include header/mail_dialog.h -o moc_mail_dialog.cpp

moc_threads.cpp: utils/threads.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/yt/pro/qt/popBall/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/yt/pro/qt/popBall -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtCore -I/usr/include/c++/9.2.0 -I/usr/include/c++/9.2.0/x86_64-pc-linux-gnu -I/usr/include/c++/9.2.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.2.0/include-fixed -I/usr/include utils/threads.h -o moc_threads.cpp

compiler_moc_objc_header_make_all:
compiler_moc_objc_header_clean:
compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_configure_dialog.h ui_mail_dialog.h
compiler_uic_clean:
	-$(DEL_FILE) ui_configure_dialog.h ui_mail_dialog.h
ui_configure_dialog.h: configure_dialog.ui \
		/usr/bin/uic
	/usr/bin/uic configure_dialog.ui -o ui_configure_dialog.h

ui_mail_dialog.h: mail_dialog.ui \
		/usr/bin/uic
	/usr/bin/uic mail_dialog.ui -o ui_mail_dialog.h
...
data_struct.o: data_struct/data_struct.cpp header/data_struct.h \
		header/define.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o data_struct.o data_struct/data_struct.cpp

global_data.o: data_struct/global_data.cpp header/data_struct.h \
		header/define.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o global_data.o data_struct/global_data.cpp

configure_dialog.o: dialog/configure_dialog.cpp header/configure_dialog.h \
		header/define.h \
		header/data_struct.h \
		header/widget.h \
		header/get_sys_info.h \
		utils/threads.h \
		utils/dealtConfigFile.h \
		ui_configure_dialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o configure_dialog.o dialog/configure_dialog.cpp

mail_dialog.o: dialog/mail_dialog.cpp header/mail_dialog.h \
		ui_mail_dialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mail_dialog.o dialog/mail_dialog.cpp

get_sys_info.o: get_sys_info/get_sys_info.cpp header/get_sys_info.h \
		header/data_struct.h \
		header/define.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o get_sys_info.o get_sys_info/get_sys_info.cpp

main.o: main.cpp header/widget.h \
		header/define.h \
		header/get_sys_info.h \
		header/data_struct.h \
		header/configure_dialog.h \
...
dealtConfigFile.o: utils/dealtConfigFile.cpp utils/dealtConfigFile.h \
		header/define.h \
		header/data_struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dealtConfigFile.o utils/dealtConfigFile.cpp

pop3.o: utils/pop3.cpp utils/pop3.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o pop3.o utils/pop3.cpp

threads.o: utils/threads.cpp utils/threads.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o threads.o utils/threads.cpp

widget.o: widget/widget.cpp header/widget.h \
		header/define.h \
		header/get_sys_info.h \
		header/data_struct.h \
		header/configure_dialog.h \
...
widget_ConfigFile.o: widget/widget_ConfigFile.cpp header/widget.h \
		header/define.h \
		header/get_sys_info.h \
		header/data_struct.h \
		header/configure_dialog.h \
		utils/dealtConfigFile.h \
		utils/threads.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o widget_ConfigFile.o widget/widget_ConfigFile.cpp

widget_Content.o: widget/widget_Content.cpp header/widget.h \
		header/define.h \
		header/get_sys_info.h \
		header/data_struct.h \
		header/configure_dialog.h \
		utils/dealtConfigFile.h \
		utils/threads.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o widget_Content.o widget/widget_Content.cpp

widget_Ending.o: widget/widget_Ending.cpp header/widget.h \
		header/define.h \
		header/get_sys_info.h \
		header/data_struct.h \
		header/configure_dialog.h \
		utils/dealtConfigFile.h \
		utils/threads.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o widget_Ending.o widget/widget_Ending.cpp

widget_EventFunc.o: widget/widget_EventFunc.cpp header/widget.h \
		header/define.h \
		header/get_sys_info.h \
		header/data_struct.h \
		header/configure_dialog.h \
		...
		utils/threads.h \
		header/mail_dialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o widget_EventFunc.o widget/widget_EventFunc.cpp

widget_Initial.o: widget/widget_Initial.cpp header/widget.h \
		header/define.h \
		header/get_sys_info.h \
		header/data_struct.h \
		header/configure_dialog.h \
		utils/dealtConfigFile.h \
		utils/threads.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o widget_Initial.o widget/widget_Initial.cpp

widget_RightContextMenu.o: widget/widget_RightContextMenu.cpp header/widget.h \
		header/define.h \
		header/get_sys_info.h \
		header/data_struct.h \
		header/configure_dialog.h \
		utils/dealtConfigFile.h \
		utils/threads.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o widget_RightContextMenu.o widget/widget_RightContextMenu.cpp

widget_UIAndPaintEvent.o: widget/widget_UIAndPaintEvent.cpp header/widget.h \
		header/define.h \
		header/get_sys_info.h \
		header/data_struct.h \
		header/configure_dialog.h \
		utils/dealtConfigFile.h \
		utils/threads.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o widget_UIAndPaintEvent.o widget/widget_UIAndPaintEvent.cpp

widget_WindowPositionStyle.o: widget/widget_WindowPositionStyle.cpp header/widget.h \
		header/define.h \
		header/get_sys_info.h \
		header/data_struct.h \
		header/configure_dialog.h \
		utils/dealtConfigFile.h \
		utils/threads.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o widget_WindowPositionStyle.o widget/widget_WindowPositionStyle.cpp

qrc_clock.o: qrc_clock.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_clock.o qrc_clock.cpp

qrc_mail.o: qrc_mail.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_mail.o qrc_mail.cpp

moc_configure_dialog.o: moc_configure_dialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_configure_dialog.o moc_configure_dialog.cpp

moc_widget.o: moc_widget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_widget.o moc_widget.cpp

moc_mail_dialog.o: moc_mail_dialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_mail_dialog.o moc_mail_dialog.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/popBall/bin || mkdir -p $(INSTALL_ROOT)/opt/popBall/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/popBall/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/popBall/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/popBall/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/popBall/bin/ 
