...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		popBall.pro datastruct.h \
		getsysinfo.h \
		widget.h datastruct.cpp \
		getsysinfo.cpp \
		main.cpp \
		widget.cpp
...
distdir: FORCE
	...
	$(COPY_FILE) --parents datastruct.h getsysinfo.h widget.h $(DISTDIR)/
	$(COPY_FILE) --parents datastruct.cpp getsysinfo.cpp main.cpp widget.cpp $(DISTDIR)/
...
moc_widget.cpp: widget.h \
		...
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/yt/pro/qt/popBall/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/yt/pro/qt/popBall -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/9.2.0 -I/usr/include/c++/9.2.0/x86_64-pc-linux-gnu -I/usr/include/c++/9.2.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.2.0/include-fixed -I/usr/include widget.h -o moc_widget.cpp
...
datastruct.o: datastruct.cpp datastruct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o datastruct.o datastruct.cpp

getsysinfo.o: getsysinfo.cpp getsysinfo.h \
		datastruct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o getsysinfo.o getsysinfo.cpp
